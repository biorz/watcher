...
var _emit2 = __webpack_require__(3);
...
var watcher = function (_emit) {
  ...
  _createClass(watcher, [{
    ...
    value: function getParentItera(fn, el) {
      ...
      do {
        parent = (0, _dom.getScrollParent)(el);
        rst = fn(el, parent);
        el = parent;
    ...
    value: function inView(element) {
      ...
      this.getParentItera(function (el) {
        if (!parent) {
          rect2 = self.getOffsetRect(rect, self.vp);
          rect = (0, _dom.getOffset)(rect, rect2);
          return false;
        }
...
exports.tween = exports.RAF = exports.itera = undefined;

var _dom = __webpack_require__(0);

var itera = exports.itera = function itera(fn, first) {
  var itera = function itera(para) {
    var rst = fn(para);
